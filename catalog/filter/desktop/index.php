...
<head>
  ...
  <script src="https://api-maps.yandex.ru/2.1/?apikey=9b339b12-4d97-4522-b2e5-da5a5da1c7f6&lang=ru_RU"
...
<body>
  <div class="container" data-candy="s<?=rand(0, 1000000)?>">
    ...
    <div class="search-form">
      ...
      <div class="type">
        <input data-elem="check" class="start__input" name="reqTypeofRealty" type="text" value="Квартиры"
          autocomplete="new-password" readonly>
        <span class='start__input-arrow'></span>
        <div data-elem="check" class="type__wrap reqTypeofRealty__block visible">
          <span data-input="reqTypeofRealty" data-value="Квартиры" data-elem="check"
            class="type__select">Квартиры</span>
          <span data-input="reqTypeofRealty" data-value="Комнаты" data-elem="check" class="type__select">Комнаты</span>
          <span data-input="reqTypeofRealty" data-value="Дома, коттеджи, дачи" data-elem="check"
            class="type__select">Дома, коттеджи, дачи</span>
          <span data-input="reqTypeofRealty" data-value="Земля" data-elem="check" class="type__select">Земля</span>
          <span data-input="reqTypeofRealty" data-value="Гаражи, парковки" data-elem="check"
            class="type__select">Гаражи, парковки</span>
        </div>
      </div>
      <div class="address">
      ...
      <div class="room">
        <input data-elem="check" class="start__input" name="reqRoomCount" type="text" placeholder="Любое"
          autocomplete="new-password" readonly>
        ...
        <div data-elem="check" class="room__check reqRoomCount__block visible">
          <label data-elem="check" class="room__label" for="one">
            <input data-input="reqRoomCount" data-room="1-комнатные" data-elem="check" id="one" type="checkbox"
              value="1">
            <span data-elem="check" class="room__text">1-комнатные</span>
          </label>
          <label data-elem="check" class="room__label" for="two">
            <input data-input="reqRoomCount" data-room="2-комнатные" data-elem="check" id="two" type="checkbox"
              value="2">
            <span data-elem="check" class="room__text">2-комнатные</span>
          </label>
          <label data-elem="check" class="room__label" for="three">
            <input data-input="reqRoomCount" data-room="3-комнатные" data-elem="check" id="three" type="checkbox"
              value="3">
            <span data-elem="check" class="room__text">3-комнатные</span>
          </label>
          <label data-elem="check" class="room__label" for="for">
            <input data-input="reqRoomCount" data-room="4-комнатные" data-elem="check" id="for" type="checkbox"
              value="4">
            <span data-elem="check" class="room__text">4-комнатные</span>
          </label>
          <label data-elem="check" class="room__label" for="lot">
            <input data-input="reqRoomCount" data-room="Многокомнатные" data-elem="check" id="lot" type="checkbox"
              value="5">
      ...
      <div class="price">
        <input data-elem="check" class="start__input" name="reqPrice" type="text" placeholder="Любая"
          autocomplete="new-password" readonly>
        ...
        <div data-elem="check" class="price__wrap-all reqPrice__block visible">
          <div data-elem="check" class="price__wrap-input">
            <input data-input="reqPrice" data-elem="check" class="price__input price_left" name="from" type="text"
              placeholder="От">
            <span data-elem="check">&#8212;</span>
            <input data-input="reqPrice" data-elem="check" class="price__input price_right" name="to" type="text"
              placeholder="До">
          </div>
        </div>
      </div>
      <div class="builder">
        <input data-type='' data-elem="check" class="start__input" name="builder" type="text" value=""
    ...
    <div class='setting'>
      <div class="sort">
        ...
        <div data-elem="check" class="sort__wrap sort__block visible">
          <span data-action="default" data-input="sort" data-value="Сортировка по умолчанию" data-elem="check"
            class="type__select">Сортировка по умолчанию</span>
          <span data-action="newOld" data-input="sort" data-value="Дата публикации от новых к старым" data-elem="check"
            class="type__select">По дате обновления</span>
          <span data-action="priceLow" data-input="sort" data-value="Цена от низкой к высокой" data-elem="check"
            class="type__select">Цена от низкой к высокой</span>
          <span data-action="priceHigh" data-input="sort" data-value="Цена от высокой к низкой" data-elem="check"
            class="type__select">Цена от высокой к низкой</span>
          <span data-action="areaLow" data-input="sort" data-value="Площадь от меньшей к большей" data-elem="check"
            class="type__select">Площадь от меньшей к большей</span>
          <span data-action="areaHigh" data-input="sort" data-value="Площадь от большей к меньшей" data-elem="check"
            class="type__select">Площадь от большей к меньшей</span>
          <span data-action="wordFirst" data-input="sort" data-value="Адрес от А до Я" data-elem="check"
            class="type__select">Адрес от А до Я</span>
          <span data-action="wordLast" data-input="sort" data-value="Адрес от Я до А" data-elem="check"
            class="type__select">Адрес от Я до А</span>
        </div>
      </div>
      <p class='quantity'></p>
      <div>
        ...
        <div style='display: flex; gap: 0.5rem'>
          <div class='basket'>
            <button title="Новый объект" class="btn-add ui-btn ui-btn-primary" data-name="add">Добавить новый
              объект</button>
          ...
          <div class="buttons">
            <div class='btn__wrap-extra'>
              <button title="Еще фильтры" class="ui-btn btn-search bx-btn__craft" data-name="extra">Доп.
                фильтры</button>
